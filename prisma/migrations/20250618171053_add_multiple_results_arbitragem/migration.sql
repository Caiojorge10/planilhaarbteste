/*
  ...
  - Added the required column `resultado1` to the `Arbitragem` table without a default value. This is not possible if the table is not empty.
  - Added the required column `resultado2` to the `Arbitragem` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Arbitragem" ("casa1Id", "casa2Id", "data", "esporte", "evento", "id", "ladoVencedor", "lucroEsperado", "odd1", "odd2", "stake1", "stake2", "status", "resultado1", "resultado2") SELECT "casa1Id", "casa2Id", "data", "esporte", "evento", "id", "ladoVencedor", "lucroEsperado", "odd1", "odd2", "stake1", "stake2", "status", 'Vitória Casa 1', 'Vitória Casa 2' FROM "Arbitragem";
